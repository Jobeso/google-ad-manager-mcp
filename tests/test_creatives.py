...
class TestUploadHtml5Creative:
    ...
    def test_uploads_html5_creative_successfully(self, mock_path_class, mock_file, mock_get_client):
        ...
        # Html5Creative has no destinationUrl field in the GAM schema; including
        # it makes zeep raise KeyError when marshalling. Click URL must come
        # from the bundle's clickTAG macro.
        assert "destinationUrl" not in payload
